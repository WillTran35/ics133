    ...
    <>
      <div className="search-page">
        <div className="search-box">
          ...
          <div>
              <Button type="submit" color = "blue" value="submit" form = "main-form" disabled = {!selectedTimezone && !selectedLocation} >
                Get Time!
              </Button>
            </div>
            ...
            {currentTime && (
          <div>
            <p>This is the current time at for the selected Timezone and Location: {currentTime}</p>
          </div>
        )}
